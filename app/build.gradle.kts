...
android {
    ...
    defaultConfig {
        applicationId = "com.example.geekplayproyecto" // <- actualizado
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Navegación / Lifecycle / Coroutines - USANDO VERSIONES ESTABLES ALINEADAS
    ...
    // Room (SQLite) + KTX - USANDO ALIAS DEL TOML (¡La forma correcta y limpia!)
