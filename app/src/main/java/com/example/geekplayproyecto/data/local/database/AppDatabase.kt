...
import com.example.geekplayproyecto.data.local.ban.BanNotificationDao
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun banNotificationDao(): BanNotificationDao
                        ...
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                INSTANCE?.let { database ->
                                    ...
                                    val banNotificationDao = database.banNotificationDao()
                                    ...
                                    // Precargar notificación de baneo
                                    banNotificationDao.insert(BanNotification(
                                        userId = 2L,
                                        reason = "Comportamiento inadecuado en los comentarios.",
                                        duration = "Permanente",
