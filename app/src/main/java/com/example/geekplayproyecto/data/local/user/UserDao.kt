...
interface UserDao {
    ...
    // Actualiza la fecha de baneo de un usuario
    @Query("UPDATE users SET bannedUntil = :bannedUntil WHERE id = :userId")
    suspend fun updateBannedUntil(userId: Long, bannedUntil: Long?)
