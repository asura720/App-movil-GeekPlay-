...
data class CreatePostUiState(
    ...
    val imageUri: String? = null, // Para la URI de la imagen seleccionada
...
class CreatePostViewModel(
    ...
    fun create(authorName: String, authorEmail: String, context: Context) {
        ...
        viewModelScope.launch {
            ...
            val user = userRepo.findByEmail(authorEmail)
            if (user == null) {
                _ui.update { it.copy(errorMsg = "Error: No se encontró el usuario.") }
                return@launch
            }
